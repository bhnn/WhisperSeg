...
script1="train.py"
script2="evaluate.py"
data_tar="$base_dir/data/lemur_tar/data_balanced/lemur_data_cfg${cfg}_balanced.tar"
label_tar="$base_dir/data/lemur_tar/labels_balanced/lemur_labels_cfg${cfg}_balanced.tar"
