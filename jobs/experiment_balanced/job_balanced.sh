...
code_dir="$base_dir"
experiment_dir="labels_balance_cuts"
script1="train.py"
script2="evaluate.py"
data_tar="$base_dir/data/lemur_tar/data_balance_cuts/lemur_data_cfg${cfg}_balanced.tar"
label_tar="$base_dir/data/lemur_tar/$experiment_dir/lemur_labels_cfg${cfg}_balanced.tar"
model_dir_in="nccratliri/whisperseg-base-animal-vad"
model_dir_out="$base_dir/model/$(date +"%Y%m%d_%H%M%S")_j${SLURM_JOB_ID}_wseg-base_balanced"
output_dir="$base_dir/results"
output_identifier="base_j${SLURM_JOB_ID}_balanced"
