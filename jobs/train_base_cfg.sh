...
model_dir_out="$base_dir/model/$(date +"%Y%m%d_%H%M%S")_j${SLURM_JOB_ID}_wseg-base-cfg-$cfg"
output_dir="$base_dir/results"
output_identifier="base_cfg${cfg}_j${SLURM_JOB_ID}"
...
patience=10
val_ratio=0.2
wandb_notes="cfg${cfg}, rtx5000:1, bs${batch_size}, ep${epochs}, vratio${val_ratio}, pat${patience}"
...
mkdir -p "$job_dir"/{pretrain_ckpt,finetune_ckpt,wandb}
