...
if [ "$#" -ne 3 ]; then
    echo "Usage: $0 <batch_size> <learning_rate> <config_set>"
...
model_dir_out="$base_dir/model/$(date +"%Y%m%d_%H%M%S")_j${SLURM_JOB_ID}_wseg-base_bslr"
output_dir="$base_dir/results"
output_identifier="base_j${SLURM_JOB_ID}_bslr"
