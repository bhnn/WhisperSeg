...
python $base_dir/util/make_json.py -p $source_dir/finetune -t 0.5 -d 2.5 -o data/data_backup/finetune -a animal_filter_replace -f mo w --merge_targets
python $base_dir/util/make_json.py -p $source_dir/finetune -t 0.5 -d 2.5 -o data/data_backup/pretrain -a animal
