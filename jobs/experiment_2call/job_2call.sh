...
script1="train.py"
script2="evaluate.py"
data_tar="$base_dir/data/lemur_tar/data_2call/lemur_data_cfg${cfg}_2call.tar"
label_tar="$base_dir/data/lemur_tar/labels_2call/lemur_labels_cfg${cfg}_2call.tar"
model_dir_in="nccratliri/whisperseg-base-animal-vad"
model_dir_out="$base_dir/model/$(date +"%Y%m%d_%H%M%S")_j${SLURM_JOB_ID}_wseg-base_2call"
output_dir="$base_dir/results"
output_identifier="base_j${SLURM_JOB_ID}_2call"
