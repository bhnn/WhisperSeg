...
do
    ...
    python $base_dir/util/make_json.py -p $source_dir/finetune -t $tol_str -d 2.5 -o $source_dir/finetune
    python $base_dir/util/make_json.py -p $source_dir/finetune -t $tol_str -d 2.5 -o $source_dir/pretrain -a animal
