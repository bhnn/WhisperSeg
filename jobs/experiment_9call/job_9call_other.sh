...
script1="train.py"
script2="evaluate.py"
data_tar="$base_dir/data/lemur_tar/data_9call_other/lemur_data_cfg${cfg}_9call_other.tar"
label_tar="$base_dir/data/lemur_tar/labels_9call_other/lemur_labels_cfg${cfg}_9call_other.tar"
model_dir_in="nccratliri/whisperseg-base-animal-vad"
model_dir_out="$base_dir/model/$(date +"%Y%m%d_%H%M%S")_j${SLURM_JOB_ID}_wseg-base_9call_other"
output_dir="$base_dir/results"
output_identifier="base_j${SLURM_JOB_ID}_9call_other"
