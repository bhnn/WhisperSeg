...
if [ "$#" -ne 2 ]; then
    echo "Usage: $0 <dropout> <config_set>"
...
model_dir_out="$base_dir/model/$(date +"%Y%m%d_%H%M%S")_j${SLURM_JOB_ID}_wseg-base_dropout"
output_dir="$base_dir/results"
output_identifier="base_j${SLURM_JOB_ID}_dropout"
...
patience=10
val_ratio=0.1
wandb_notes="cfg${cfg}, dropout${dropout}, rtx5000:1, tol0.5, bs${batch_size}, lr${learning_rate}, vratio${val_ratio}, pat${patience}"
