...
script1="train.py"
script2="evaluate.py"
data_tar="$base_dir/data/lemur_tar/data_moan_drop/lemur_data_cfg${cfg}_moan_drop.tar"
label_tar="$base_dir/data/lemur_tar/labels_moan_drop/lemur_labels_cfg${cfg}_moan_drop.tar"
model_dir_in="nccratliri/whisperseg-base-animal-vad"
model_dir_out="$base_dir/model/$(date +"%Y%m%d_%H%M%S")_j${SLURM_JOB_ID}_wseg-base_moan_drop"
output_dir="$base_dir/results"
output_identifier="base_j${SLURM_JOB_ID}_moan_drop"
...
patience=10
val_ratio=0.1
wandb_notes="cfg${cfg}, single-drop, rtx5000:1, tol0.5, bs${batch_size}, lr${learning_rate}, vratio${val_ratio}, pat${patience}"
