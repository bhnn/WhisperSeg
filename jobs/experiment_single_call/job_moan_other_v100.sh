...
model_dir_out="$base_dir/model/$(date +"%Y%m%d_%H%M%S")_j${SLURM_JOB_ID}_wseg-large_moan_other"
output_dir="$base_dir/results"
output_identifier="large_j${SLURM_JOB_ID}_moan_other"
...
patience=10
val_ratio=0.1
wandb_notes="cfg${cfg}, single-other, rtx5000:1, tol0.5, bs${batch_size}, lr${learning_rate}, vratio${val_ratio}, pat${patience}"
...
python "$code_dir/$script1" \
    ...
    --run_tags "large" "exp_single_other"
