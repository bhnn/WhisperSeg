...
do
    ...
    python $base_dir/util/make_json.py -p $source_dir/finetune -t 0.5 -d $clipd_str -o $source_dir/finetune
    python $base_dir/util/make_json.py -p $source_dir/finetune -t 0.5 -d $clipd_str -o $source_dir/pretrain -a animal
