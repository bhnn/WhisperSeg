...
model_dir_out="$base_dir/model/$(date +"%Y%m%d_%H%M%S")_j${SLURM_JOB_ID}_wseg-base_aug_unsupervised"
output_dir="$base_dir/results"
output_identifier="base_j${SLURM_JOB_ID}_aug_unsupervised"
