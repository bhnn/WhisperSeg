...
python $base_dir/util/make_json.py -p $source_dir/finetune -t 0.01 -d 2.5 -o $source_dir/finetune
python $base_dir/util/make_json.py -p $source_dir/finetune -t 0.01 -d 2.5 -o $source_dir/pretrain -a animal
