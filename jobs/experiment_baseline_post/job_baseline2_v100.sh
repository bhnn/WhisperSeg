...
label_tar="$base_dir/data/lemur_tar/$experiment_dir/lemur_labels_cfg${cfg}_clipd25.tar"
...
patience=10
val_ratio=0.1
wandb_notes="cfg${cfg}, V100:1, tol0.5, bs${batch_size}, lr${learning_rate}, vratio${val_ratio}, pat${patience}"
